...
export default function Home() {
    return (
        <>
            <div className="w-full h-[calc(100vh-184px)] bg-[linear-gradient(0deg,rgba(0,0,0,0.36),rgba(0,0,0,0.36)),url('../src/assets/images/home-hero.png')] bg-no-repeat bg-center bg-cover py-[45px] px-5 xl:px-0">
